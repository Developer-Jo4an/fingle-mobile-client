...
import { clickGrayBackground, mainGreenColor, mainGreenDarkColor, noClickColor } from '../../styles/global'
import { styles } from './account-styles'

const Account = ({ account, clickFunction, disabled }) => {
